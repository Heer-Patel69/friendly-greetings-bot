            ...
            >
              <div className="glass-strong rounded-2xl p-4 space-y-3 border border-accent/20">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold text-accent uppercase tracking-[0.15em]">New Product</h4>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <select
                    ...
                    className="h-11 px-3 rounded-xl glass text-sm text-foreground bg-transparent focus:ring-2 focus:ring-primary/30 outline-none"
                  >
                    {CATEGORIES.map((c) => (
